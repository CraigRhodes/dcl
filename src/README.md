...
The stock C compiler compiles printbig.o.  testall.sh runs the dcl
...
9. To run and test, navigate to the DCL folder. Once there, run

   make ; ./testall.sh

   DCL should build without any complaints and all tests should
   pass.
